...
class Params
{
  public:
    ...
    const char *class_name [num_classes] = { "Car","Bus","Pedestrian","Motorcycle",};
    const float min_x_range = -26.4;
    const float max_x_range = 50.4;
    ...
    const float anchor_bottom_heights[num_classes] = {-1.78,-1.68,-0.6,-0.6,};
